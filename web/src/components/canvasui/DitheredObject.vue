<!--
  ...
  Component : DitheredObject (dithered-object-vue)
  Source    : https://canvasui.dev/r/dithered-object-vue.json
...
onMounted(() => {
  ...
  if (!instance) {
    props.onError?.(new Error("DitheredObject: WebGL2 context unavailable"));
  }
});
